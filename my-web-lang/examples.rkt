...
(define-example-code my-web-lang/main 001-blog-title-intro
...
(define-example-code my-web-lang/main 002-blog-post-intro
...
(define-example-code my-web-lang/main 004-style-intro
...
(define-example-code my-web-lang/main 003-blog-multiple-posts-intro
...
(define-example-code my-web-lang/main 005-links-intro
...
(define-example-code my-web-lang/main 002-video-media
...
(define-example-code my-web-lang/main 006-styled-links-intro
...
(define-example-code my-web-lang/main 001-ordered-lists
...
(define-example-code my-web-lang/main 002-styled-ordered-lists
...
(define-example-code my-web-lang/main 003-ordered-lists-block
...
(define-example-code my-web-lang/main 004-bordered-ordered-lists-block
...
(define-example-code my-web-lang/main 005-unordered-lists
...
(define-example-code my-web-lang/main 006-styled-unordered-lists
...
(define-example-code my-web-lang/main 007-unordered-lists-block
...
(define-example-code my-web-lang/main 008-bordered-unordered-lists-block
...
(define-example-code my-web-lang/main 003-background-image-media
...
(define-example-code my-web-lang/main 001-text-color
...
(define-example-code my-web-lang/main 008-colorful-title
...
(define-example-code my-web-lang/main 002-text-outline
...
(define-example-code my-web-lang/main 004-text-shadow
...
(define-example-code my-web-lang/main 001-image-media
  (define (start request)
    (response/xexpr
     '(html
       (head (title "My Blog"))
...
(define-example-code my-web-lang/main 003-text-font
